...
my_write.csv(fish_analysis[[1]], "output/analysis/", "raw res_qgcomp_fish") # results
my_write.csv(fish_analysis[[2]], "output/analysis/", "raw weights_qgcomp_fish") # weights
my_write.csv(fish_analysis[[3]], "output/analysis/", "raw pooled weights_qgcomp_fish") # pooled weights
